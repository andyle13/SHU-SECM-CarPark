...
namespace SECM___Car_Park_Prototype_1
{
    public partial class FacialRecognition : Form
    {
        ...
        public FacialRecognition(CarPark carPark, List<CarParkDB> cpPanels, Customer selectedCustomer, ParkingBay pb)
        {
            InitializeComponent();
            _carPark = carPark;
            _cpPanels = cpPanels;
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            if(Convert.ToInt32(label3.Text.ToString()) == 1)
            {
                if (numberoftimes == 0)
                {
                    ...
                    _pb.IsCorrectCam();
                    System.IO.DirectoryInfo di = new DirectoryInfo(Application.StartupPath + "/TrainedFaces/");
